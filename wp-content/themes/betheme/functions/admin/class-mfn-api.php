...
class Mfn_API {
	...
	protected $url = array(
		...
		'changelog'			=> 'http://themes.muffingroup.com/betheme/documentation/changelog.html',
			
		'register'			=> 'http://api.muffingroup.com/register.php',
			
		'theme_version'		=> 'http://api.muffingroup.com/theme/version.php',
		'theme_download'	=> 'http://api.muffingroup.com/theme/download.php',
	...
	function refresh_update_version(){
		...
		// set transient
		set_site_transient( 'betheme_update', $version, MINUTE_IN_SECONDS * 5 );
